    ...
    <div class="navbar-wrapper">
      <div class="navbar">
        ...
        <ul>
          ...
          <li><a href="landing.php#Book">Book</a></li>
     ...
     <section>
        <div class="slot-container">
            <div class="slot-overview">
                <?php $fetchParking = fetchParking();?>
                <?php include 'components/Booking/floorsLayout.php';?>
            </div>
        </div>
        <div class="book-container">
            <div class="header">
                <span>Book a Slot</span>
                <span class="description">Enter your details</span>
            </div>
            <?php
            ...
            ?>
                <form action="php/parkingExecute.php" method="POST">
                    <div class="lists-wrapper">
                        ...
                        <div class="plate-number">
                        <input type="text" id="plateNumber" class="plate-input" name="phone_number" autocomplete="off" oninput="convertToUppercase()" placeholder=" " required>
                        <label for="plateNumber">Enter Phone Number</label>
                        </div>

                        <div class="plate-number">
                        <input type="text" id="plateNumber" class="plate-input" name="email" autocomplete="off" oninput="convertToUppercase()" placeholder=" " required>
                        <label for="plateNumber">Enter Email Address</label>
                        </div>

                    </div>
                    <input class="user-input" type="hidden" name="user_type" value="Reservee" required>
                    <div class="booking-cta">
                        <button type="submit" name="reserveSlot" class="bookButton">Book</button>
                    </div>
            </form>
        </div>
     </section>
...
function toggleVehicleType() {
    ...
    if (selectedFloor === '1') {
     ...
     <script src="js/Booking/floorPagination.js"></script>
</body>
</html>