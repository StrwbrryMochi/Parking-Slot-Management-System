            ...
            ?>
                <form action="../php/parkingExecute.php" method="POST">
                    ...
                    <div class="vehicle-type-header">Select Vehicle</div>
                        ...
                        <label>
                            <input class="vehicle-input" type="radio" name="vehicle_type" value="Bicycle" required>
                        ...
                        <label>
                            <input checked="" class="vehicle-input" type="radio" name="vehicle_type" value="Motorcycle" required>
                            <span class="vehicle-tile">
                                <span class="vehicle-icon">
                                ...
                                <span class="vehicle-label">Motorcylce</span>
                            </span>
                        </label>
                        <label>
                            <input class="vehicle-input" type="radio" name="vehicle_type" value="Car" required>
                            <span class="vehicle-tile">
                                <span class="vehicle-icon">
                    ...
                    <div class="user-container">
                        <div class="user-type-header">Select User</div>
