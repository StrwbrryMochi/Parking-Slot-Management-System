            ...
            <div class="modal-body edit">
                ...
                <div class="lists-wrapper">
                        ...
                        <div class="slot-status">
                            <div class="slot-status-header">Status</div>
                       
                            <label>
                                <input class="status-input" type="radio" name="Status" id="OccupiedInput" value="Occupied" required>
                            ...
                            <label>
                                <input class="status-input" type="radio" name="Status" id="AvailableInput" value="Available" required>
                                    <span class="status-tile">
                                        <span class="status-icon">
                            ...
                            <label>
                                <input class="status-input" type="radio" name="Status" id="OutofServiceInput" value="Unavailable" required>
                                    <span class="status-tile">
                                        <span class="status-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <div class="edit-vehicle-header">Vehicle</div>
                            ...
                            <label>
                                <input checked="" class="vehicle-input" type="radio" name="vehicle_type" id="MotorcycleInputId" value="Motorcycle"  required>
                                <span class="vehicle-tile">
                                    <span class="vehicle-icon">
                            ...
                            <label>
                                <input class="vehicle-input" type="radio" name="vehicle_type" value="Car" id="CarInputId"  required>
                                <span class="vehicle-tile">
                                    <span class="vehicle-icon">
                            ...
                            <div class="edit-user-container">
                                ...
                                <div class="edit-user-header">User</div>
                                    <label>
                                        <input class="user-input" type="radio" name="user_type" value="Guest">
                        ...
                        <div class="plate-number" id="last-input">
                            <input type="text" id="edit-plate-number" class="plate-input" name="plate_number" autocomplete="off" onkeyup="convertToUppercase()" placeholder=" ">
                    ...
                    <div class="modal-footer edit">
                        <div class="editButton-container">
                            <button type="submit" class="btn btn-primary" id="EditButton" name="slotEdit">
